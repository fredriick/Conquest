...
- 🎭 Character Classes
  - Warrior: 20% more battle token rewards
  - Mage: 20% cheaper power-ups
  - Rogue: Chance to steal extra tokens
- 🎁 Achievement System
  - First Blood: Win first battle
  - Warrior: Win 10 battles
  - Champion: Win a tournament
  - Wealthy: Accumulate 1000 tokens
  - Streak Master: Win 5 battles in a row
- ⚡ Power-up System
  - Double Damage: 2x battle rewards
  - Shield: 50% loss reduction
  - Lucky Charm: 20% more rating points
- 👥 Referral System
